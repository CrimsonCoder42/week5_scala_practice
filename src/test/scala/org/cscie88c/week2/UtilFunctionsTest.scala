...
class UtilFunctionsTest extends StandardTest{
  ...
  "UtilFunctions" when {
    "maximum" should {
  "calculates the maximum of two integers 1" in {
    UtilFunctions.maximum(3,7) shouldBe (7)
  }
  "calculates the maximum of two integers 2" in {
    UtilFunctions.maximum(8, 4) shouldBe (8)
      }
    }

// average
    "average" should {
      "calculates the average of two integers 1" in {
        UtilFunctions.average(3,7) shouldBe (5)
      }
      "calculates the average of two integers 2" in {
        UtilFunctions.average(8, 4) shouldBe (6)
      }
    }
  }
